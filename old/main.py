...
class MyApp(QWidget):
    def __init__(self):
        ...
        self.window_width, self.window_height = 800, 00
        ...
        # self.combo_month.currentIndexChanged.connect(lambda x: self.month_options.index(str(datetime.today().month)))
